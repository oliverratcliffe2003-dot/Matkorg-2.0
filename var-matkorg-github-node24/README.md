...
## GitHub Actions och Node.js 24

Projektet innehåller `.github/workflows/pages.yml` med aktuella Node.js 24-kompatibla Actions:
...
I **Settings → Pages** ska källan vara **GitHub Actions**. Om det redan finns en äldre Pages-workflow i `.github/workflows`, ta bort den eller ersätt den med `pages.yml` i detta paket.
